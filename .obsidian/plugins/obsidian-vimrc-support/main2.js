...
var mappingCommands = ["map", "nmap", "noremap", "iunmap", "nunmap", "vunmap"];
function sleep(ms) {
...
var VimrcPlugin = /** @class */ (function (_super) {
  ...
  function VimrcPlugin() {
    ...
    _this.logVimModeChange = function (cm) {
      return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
          if (!cm) return [2 /*return*/];
          ...
          if (this.settings.displayVimMode)
            (_a = this.vimStatusBar) === null || _a === void 0
              ? void 0
              : _a.setText(this.currentVimStatus);
          return [2 /*return*/];
        });
      });
    };
    _this.onVimKeypress = function (vimKey) {
      return __awaiter(_this, void 0, void 0, function () {
        var tempS, _i, _a, s;
        var _b;
        return __generator(this, function (_c) {
          if (vimKey != "<Esc>") {
            // TODO figure out what to actually look for to exit commands.
            this.currentKeyChord.push(vimKey);
            if (
              this.customVimKeybinds[this.currentKeyChord.join("")] != undefined
            ) {
          ...
          (_b = this.vimChordStatusBar) === null || _b === void 0
            ? void 0
            : _b.setText(tempS);
          return [2 /*return*/];
        });
    ...
    _this.onVimCommandDone = function (reason) {
      return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
          (_a = this.vimChordStatusBar) === null || _a === void 0
            ? void 0
            : _a.setText("");
          this.currentKeyChord = [];
          return [2 /*return*/];
          ...
          case 1:
            ...
            doneIterating = new Promise(function (resolve, reject) {
              ...
              layout.forEach(function (value, index) {
                keyMap[index] = value;
                counted += 1;
                if (counted === layout.size) resolve();
              });
            });
  ...
  VimrcPlugin.prototype.initialize = function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        this.codeMirrorVimObject =
          (_a = window.CodeMirrorAdapter) === null || _a === void 0
            ? void 0
            : _a.Vim;
  ...
  VimrcPlugin.prototype.updateSelectionEvent = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        if (!view) return [2 /*return*/];
        cm = this.getCodeMirror(view);
        if (
          this.getCursorActivityHandlers(cm).some(function (e) {
  ...
  VimrcPlugin.prototype.onunload = function () {
    console.log(
      "unloading Vimrc plugin (but Vim commands that were already loaded will still work)"
    );
  };
  ...
  VimrcPlugin.prototype.getCodeMirror = function (view) {
    ...
    return (_c =
      (_b =
        (_a = view.editMode) === null || _a === void 0 ? void 0 : _a.editor) ===
        null || _b === void 0
        ? void 0
        : _b.cm) === null || _c === void 0
      ? void 0
      : _c.cm;
  };
  ...
  VimrcPlugin.prototype.defineBasicCommands = function (vimObject) {
      ...
      function (value, cm) {
        if (value) {
          if (value.trim() == "unnamed" || value.trim() == "unnamedplus") {
            ...
            throw new Error(
              "Unrecognized clipboard option, supported are 'unnamed' and 'unnamedplus' (and they do the same)"
            );
          }
        }
      }
    ...
    vimObject.defineEx("noremap", "", function (cm, params) {
      var _a;
      if (
        !((_a = params === null || params === void 0 ? void 0 : params.args) ===
          null || _a === void 0
          ? void 0
          : _a.length)
      ) {
      ...
      if (params.argString.trim()) {
        _this.codeMirrorVimObject.noremap.apply(
          _this.codeMirrorVimObject,
          params.args
        );
      }
    });
    ...
    vimObject.defineEx("exmap", "", function (cm, params) {
      ...
      if (
        ...
        throw new Error(
          "exmap requires at least 2 parameters: [name] [actions...]"
        );
      }
      ...
      _this.codeMirrorVimObject.defineEx(
        commandName,
        "",
        function (cm, params) {
  ...
  VimrcPlugin.prototype.defineSendKeys = function (vimObject) {
    var _this = this;
    vimObject.defineEx("sendkeys", "", function (cm, params) {
      return __awaiter(_this, void 0, void 0, function () {
              ...
              if (
                !((_c =
                  params === null || params === void 0
                    ? void 0
                    : params.args) === null || _c === void 0
                  ? void 0
                  : _c.length)
              ) {
                console.log(params);
                throw new Error(
                  "The sendkeys command requires a list of keys, e.g. sendKeys Ctrl+p a b Enter"
                );
              }
              allGood = true;
              events = [];
            ...
            case 3:
              ...
              try {
                keyEvent = new KeyboardEvent(
                  "keydown",
                  keyboardeventFromElectronAccelerator.toKeyEvent(key)
                );
                ...
                throw new Error(
                  "Key '".concat(
                    key,
                    "' couldn't be read as an Electron Accelerator"
                  )
                );
              }
              if (allGood) {
  ...
  VimrcPlugin.prototype.defineObCommand = function (vimObject) {
    var _this = this;
    vimObject.defineEx("obcommand", "", function (cm, params) {
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          ...
          if (command in availableCommands) {
            ...
            editorCheckCallback =
              availableCommands[command].editorCheckCallback;
            if (editorCheckCallback) editorCheckCallback(false, editor, view);
            else if (editorCallback) editorCallback(editor, view);
            else if (checkCallback) checkCallback(false);
            else if (callback) callback();
            else
              throw new Error(
                "Command ".concat(command, " doesn't have an Obsidian callback")
              );
          } else throw new Error("Command ".concat(command, " was not found, try 'obcommand' with no params to see in the developer console what's available"));
          return [2 /*return*/];
        });
      });
    });
  ...
  VimrcPlugin.prototype.defineSurround = function (vimObject) {
    ...
    var surroundFunc = function (params) {
      ...
      if (!params.length) {
        throw new Error(
          "surround requires exactly 2 parameters: prefix and postfix text."
        );
      }
      ...
      if (
        ...
        (currentSelections === null || currentSelections === void 0
          ? void 0
          : currentSelections.length) > 1
      ) {
        console.log(
          "WARNING: Multiple selections in surround. Attempt to select matching cursor. (obsidian-vimrc-support)"
        );
        var cursorPos = editor.getCursor();
        for (
          var _i = 0, currentSelections_1 = currentSelections;
          _i < currentSelections_1.length;
          _i++
        ) {
          var selection = currentSelections_1[_i];
          if (
            selection.head.line == cursorPos.line &&
            selection.head.ch == cursorPos.ch
          ) {
            console.log(
              "RESOLVED: Selection matching cursor found. (obsidian-vimrc-support)"
            );
      ...
      if (
        JSON.stringify(chosenSelection.anchor) ===
        JSON.stringify(chosenSelection.head)
      ) {
      ...
      if (
        chosenSelection.anchor.line > chosenSelection.head.line ||
        (chosenSelection.anchor.line == chosenSelection.head.line &&
          chosenSelection.anchor.ch > chosenSelection.head.ch)
      )
        (_a = [chosenSelection.head, chosenSelection.anchor]),
          (chosenSelection.anchor = _a[0]),
          (chosenSelection.head = _a[1]);
      var currText = editor.getRange(
        chosenSelection.anchor,
        chosenSelection.head
      );
      editor.replaceRange(
        beginning + currText + ending,
        chosenSelection.anchor,
        chosenSelection.head
      );
    };
    vimObject.defineEx("surround", "", function (cm, params) {
      surroundFunc(params.args);
    });
    ...
    var surroundDialogCallback = function (value) {
      if (/^\[+$/.test(value)) {
        // check for 1-inf [ and match them with ]
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            yankRegister = this.codeMirrorVimObject
  ...
  VimrcPlugin.prototype.prepareChordDisplay = function () {
    if (this.settings.displayChord) {
      ...
      this.vimChordStatusBar.parentElement.insertBefore(
        this.vimChordStatusBar,
        parent_1.firstChild
      );
  ...
  VimrcPlugin.prototype.defineJsCommand = function (vimObject) {
    ...
    vimObject.defineEx("jscommand", "", function (cm, params) {
      if (!_this.settings.supportJsCommands)
        throw new Error(
          "JS commands are turned off; enable them via the Vimrc plugin configuration if you're sure you know what you're doing"
        );
      var jsCode = params.argString.trim();
      if (jsCode[0] != "{" || jsCode[jsCode.length - 1] != "}")
        throw new Error(
          "Expected an argument which is JS code surrounded by curly brackets: {...}"
        );
      var currentSelections = _this.currentSelection;
      var chosenSelection =
        currentSelections && currentSelections.length > 0
  ...
  VimrcPlugin.prototype.defineJsFile = function (vimObject) {
    var _this = this;
    vimObject.defineEx("jsfile", "", function (cm, params) {
      return __awaiter(_this, void 0, void 0, function () {
        var extraCode,
          fileName,
          currentSelections,
          ...
          switch (_b.label) {
            case 0:
              ...
              if (params.args.length > 1) {
                ...
                if (
                  extraCode[0] != "{" ||
                  extraCode[extraCode.length - 1] != "}"
                )
                  throw new Error(
                    "Expected an extra code argument which is JS code surrounded by curly brackets: {...}"
                  );
              }
            ...
            case 3:
              ...
              throw new Error(
                "Cannot read file "
                  .concat(params.args[0], " from vault root: ")
                  .concat(e_3.message)
              );
            case 4:
              command = Function(
  ...
  VimrcPlugin.prototype.defineSource = function (vimObject) {
    var _this = this;
    vimObject.defineEx("source", "", function (cm, params) {
      return __awaiter(_this, void 0, void 0, function () {
        var fileName;
        var _this = this;
        var _a;
  ...
  SettingsTab.prototype.display = function () {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addText(function (text) {
        ...
        text.setValue(
          _this.plugin.settings.vimrcFileName || DEFAULT_SETTINGS.vimrcFileName
        );
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        'Displays the current chord until completion. Ex: "<Space> f-" (requires restart)'
      )
      .addToggle(function (toggle) {
        toggle.setValue(
          _this.plugin.settings.displayChord || DEFAULT_SETTINGS.displayChord
        );
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        toggle.setValue(
          _this.plugin.settings.displayVimMode ||
            DEFAULT_SETTINGS.displayVimMode
        );
        toggle.onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        "Define a keyboard layout to always use when in Normal mode, regardless of the input language (experimental)."
      )
      ...
      .addToggle(function (toggle) {
        toggle.setValue(
          _this.plugin.settings.fixedNormalModeLayout ||
            DEFAULT_SETTINGS.fixedNormalModeLayout
        );
        toggle.onChange(function (value) {
          return __awaiter(_this, void 0, void 0, function () {
            var _a;
              ...
              switch (_b.label) {
                case 0:
                  ...
                  if (
                    !(
                      value &&
                      Object.keys(this.plugin.settings.capturedKeyboardMap)
                        .length === 0
                    )
                  )
                    return [3 /*break*/, 2];
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        "Support the 'jscommand' and 'jsfile' commands, which allow defining Ex commands using Javascript. WARNING! Review the README to understand why this may be dangerous before enabling."
      )
      .addToggle(function (toggle) {
        var _a;
        toggle.setValue(
          (_a = _this.plugin.settings.supportJsCommands) !== null &&
            _a !== void 0
            ? _a
            : DEFAULT_SETTINGS.supportJsCommands
        );
        toggle.onChange(function (value) {
